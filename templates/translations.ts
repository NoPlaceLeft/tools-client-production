export const translations: any = {
    ...
    kn: {
        translation: {
            ...
            'menu': {
                'appName': 'GenMapper',
                'defaultProjectName': 'គំរោងគ្មានឈ្មោះ',
                'project': 'គម្រោង',
                'help': 'ជំនួយ',
                'helpAbout': 'Help / About',
                'zooming': 'ពង្រីក',
                'originalZoom': 'Zoom ដើម & amp; ទីតាំង',
                'zoomIn': 'ពង្រីក',
                'zoomOut': 'បង្រួម',
                'importExport': 'នាំចូល / នាំចេញ',
                'importXlsxCsv': 'នាំចូល XLSX / CSV',
                'exportCsv': 'នាំចេញ CSV',
                'printing': 'បោះពុម្ព',
                'btnPrintVertical': 'បោះពុម្ពពហុគុណបញ្ឈរ',
                'btnPrintHorizontal': 'បោះពុម្ពផ្តេកមួយទំព័រ',
                'btnDelete': 'លុប',
                'btnSettings': 'ការកំណត់'
            },
            'editGroup': {
                'editGroup': 'កែក្រុម',
                'btnSubmit': 'ដាក់ស្នើ',
                'btnCancel': 'បោះបង់',
                'btnDelete': 'លុបកូនមាន់',
                'btnImportSubtree': 'នាំចូល subtree',
                'btnExportSubtree': 'នាំចេញអនុប្រយោគ',
                'elementParent': 'ឪពុកម្តាយ',
                'notAvailable': 'N / A',
                'hoverDeleteGroupAndSubtree': 'លុបក្រុម & amp; subtree ',
                'hoverAddChildGroup': 'បន្ថែមក្រុមកុមារ',
                'copyNodeButton': 'ចម្លង',
                'pasteNodeButton': 'បិទភ្ជាប់'
            },
            'errors': {
                'requiredField': 'វាលនេះត្រូវបានទាមទារ',
                'emailFormat': 'សូមប្រើប្រាស់ទម្រង់អ៊ីម៉ែលត្រឹមត្រូវ',
                'emailInUse': 'អ៊ីម៉ែលដែលកំពុងប្រើរួចហើយ',
                'usernameInUse': 'ឈ្មោះអ្នកប្រើប្រាស់ត្រូវបានប្រើរួចហើយ',
                'passwordsDontMatch': 'ពាក្យសម្ងាត់មិនត្រូវគ្នា',
                'invalidEmailOrPassword': 'អ៊ីមែលឬពាក្យសម្ងាត់មិនត្រឹមត្រូវ',
                'emailNotFound': 'រកមិនឃើញអ៊ីម៉ែល',
                'valueIsTooShort': 'តម្លៃខ្លីពេក'
            },
            'messages': {
                'editProjectName': 'កែសម្រួលឈ្មោះគំរោង',
                'errProjectNameEmpty': "ឈ្មោះគម្រោងមិនអាចទទេបានទេ!",
                'btnOK': 'យល់ព្រម',
                'errDeleteRoot': 'សូមទោស។ ការលុបក្រុម root មិនអាចធ្វើបានទេ។ ',
                'confirmDelete': 'អះអាងលុប?',
                'confirmDeleteGroup': 'លុបក្រុម។ ',
                'confirmDeleteGroupWithChildren': 'លុបក្រុមនិងកូនចៅទាំងអស់។ ',
                'confirmContinue': 'តើអ្នកប្រាកដថាអ្នកចង់បន្តឬ?',
                'confirmPasteNode': 'បញ្ជាក់បិទភ្ជាប់',
                'confirmPasteNodeWarning': 'បិទភ្ជាប់ថ្នាំងនេះនឹងជំនួសថ្នាំងទាំងមូលនិងកូនចៅរបស់វា។ ',
                'saveAsInSafari': 'រក្សាទុកជា: (ចំណាំ: កម្មវិធីរុករក Safari មានបញ្ហាជាមួយការនាំចេញសូមមើល GenMapper -> ជំនួយសម្រាប់ព័ត៌មានបន្ថែម)',
                'saveAs': 'រក្សាទុកជា:',
                'confirmImportSubtreeOverwrite': 'ការព្រមាន: ការបញ្ចូលពាក្យរងនឹងសរសេរជាន់លើក្រុមនេះនិងកូនចៅទាំងអស់។ តើអ្នកចង់បន្តទេ? ',
                'errImport': 'កំហុសនៅពេលនាំចូលឯកសារ។ ',
                'errImportWhatToCheck': 'សូមពិនិត្យមើលថាតើឯកសារមានទ្រង់ទ្រាយត្រឹមត្រូវ (តម្លៃដែលបំបែកដោយសញ្ញាក្បៀស) ដែលថាក្រុម root គ្មានមេហើយទំនាក់ទំនងទាំងអស់នឹងធ្វើឱ្យដើមឈើដែលត្រឹមត្រូវ។ ពិនិត្យមើលផងដែរថាអ្នកប្រើកំណែត្រឹមត្រូវរបស់ កម្មវិធី។ ',
                'selectFile': 'សូមជ្រើសរើសឯកសារ',
                'errWrongFileType': 'ប្រភេទឯកសារមិនត្រឹមត្រូវ។ សូមនាំចូលឯកសារ xls, xlsx ឬ csv ។ ',
                'changedParent': 'ក្រុមនេះនិងអនុនិរណភាពរបស់វានឹងត្រូវបានផ្លាស់ប្តូរក្រោមមាតាបិតាផ្សេងគ្នាបន្ទាប់ពីចុចលើការដាក់ស្នើការផ្លាស់ប្តូរ។ ',
                'orSendEmailTo': 'ឬផ្ញើអ៊ីមែលទៅ',
                'uniqueUsername': 'ឈ្មោះអ្នកប្រើប្រាស់តែមួយគោលដែលអាចមើលឃើញជាសាធារណៈ',
                'emailRecoveryLink': 'អ៊ីម៉ែលតំណសង្រ្គោះ',
                'enterAccountEmail': 'សូមបញ្ចូលអ៊ីម៉ែលគណនីរបស់អ្នក។ ',
                'resendRecoveryLink': 'បញ្ជូនតំណស្តាឡើងវិញឡើងវិញ',
                'recoverPassword': 'Recover Password',
                'emailSentTo': 'អ៊ីមែលដែលមានតំណសង្រ្គោះត្រូវបានបញ្ជូនទៅ',
                'enterNewPassword': 'សូមបញ្ចូលពាក្យសម្ងាត់ថ្មី',
                'passwordResetSuccess': 'ពាក្យសម្ងាត់របស់អ្នកត្រូវបានផ្លាស់ប្តូរដោយជោគជ័យ។ ឥឡូវអ្នកអាចចូល។ ',
                'somethingWentWrong': 'មានបញ្ហាអ្វីមួយ',
                'tokenInvalidOrExpired': 'សញ្ញាសម្ងាត់របស់អ្នកមិនត្រឹមត្រូវឬផុតកំណត់',
                'getMeOutOfHere': 'នាំខ្ញុំចេញពីទីនេះ'
            },
            'help': {
                'genmapperHelp': 'GenMapper ជំនួយ',
                'introContent': 'ជំរាបសួរ, កម្មវិធីនេះគួរបម្រើសម្រាប់ការគូរផែនទីនៃជំនាន់សាសនាចក្រសាមញ្ញ។ ខ្ញុំអធិស្ឋានវាបម្រើអ្នកដើម្បីជម្រុញនគររបស់ព្រះយេស៊ូវ',
                'legendHeader': 'តាង',
                'legendGroup': 'រង្វង់នីមួយៗតំណាងឱ្យក្រុមមួយ / ក្រុមជំនុំ។ រង្វង់ចារិកមានន័យថាក្រុមរង្វង់មូលមានន័យថាសាសនាចក្រ។ នៅខាងលើតួលេខពណ៌នាអំពី: # ចំនួនសរុប # អ្នកជឿ # ជ្រមុជទឹក # នៅខាងក្នុងរង្វង់គឺជាធាតុដែលត្រូវបានអនុវត្តនៅក្នុងក្រុម។ <br> នៅខាងឆ្វេង លេខ 1 ដល់ 7 តំណាងឱ្យសមាសធាតុនៃដំណើរការ 3/3 ដែលត្រូវបានអនុវត្ត: 1 - ថែរក្សាផ្ទាល់ខ្លួន 2 - គោរពបូជា 3 - គណនេយ្យភាព 4 - ចក្ខុវិស័យបញ្ចាំង 5 - ការសិក្សាព្រះគម្ពីរ 6 - ការអនុវត្ត 7 - កំណត់គោលដៅនិងការអធិស្ឋាន',
                'legendClicking': 'ចុចលើប៊ូតុងពណ៌ក្រហមដើម្បីយកចេញក្រុម។ ចុចប៊ូតុងពណ៌បៃតង (+) ដើម្បីបន្ថែមក្រុម។',
                'importExportHeader': 'នាំចូល / នាំចេញ',
                'importExportWarningChangesLost': 'ចំណាំ: ប្រសិនបើអ្នកមិននាំចេញ, ការផ្លាស់ប្តូរទាំងអស់នឹងត្រូវបាត់បង់នៅពេលដែលទំព័របើកឬបិទ។ ',
                'importExportContent': 'នាំចូល / នាំចេញអាចរកបានពីម៉ឺនុយខាងឆ្វេង។ <br> អ្នកអាចនាំចូលឯកសារ .xlsx ឬ .xls (MS Excel) ឬ .csv (តម្លៃដែលបំបែកដោយក្បៀស) ។ អ្នកក៏អាចនាំចូល / នាំចេញ មែកធាងដោយចុចលើក្រុមដែលបានផ្ដល់ហើយបន្ទាប់មកប្រើប៊ូតុង \ \'នាំចូល / នាំចេញ Subtree \' ។ <br> ការនាំចេញបច្ចុប្បន្នមានតែទ្រង់ទ្រាយ .csv ប៉ុណ្ណោះ។ ',
                'exportToPdf': 'សម្រាប់នាំចេញទៅជា PDF ប្រើប៊ូតុងបោះពុម្ពហើយរក្សាទុកជា PDF នៅក្នុង Chrome ឬ Safari ។ ',
                'panZoomHeader': 'Panning / Zoom',
                'panZoomContent': 'អ្នកអាចរុញដោយទាញផែនទីនិងពង្រីកដោយកង់កណ្តុរឬដោយប្រើប៊ូតុងនៅខាងឆ្វេង។ ',
                'keyboardShortcutsHeader': 'ផ្លូវកាត់ក្តារចុច',
                'keyboardShortcutsContent': 'Esc - បិទការកែប្រែ / help / alert windows <br> បញ្ចូល - ដាក់ស្នើបង្អួចកែសម្រួល',
                'changelogHeader': 'ការផ្លាស់ប្តូរ & amp; ព័ត៌មានកំណែ ',
                'genmapperVersion': 'GenMapper version',
                'templateVersion': 'កំណែគំរូ',
                'changelogLink': 'Changelog',
                'credititsHeader': 'ឥណទាន',
                'creditsThanks1': 'សូមអរគុណដល់ Curtis Sergeant ចំពោះគំនិតនៃការធ្វើផែនទីនិងការផ្ដល់មតិយោបល់ដែលមានប្រយោជន៍។ សូមអរគុណដល់អ្នកបកប្រែទាំងអស់នៅទូទាំងពិភពលោកដែលបានជួយបកប្រែផ្សេងៗគ្នា។',
                'creditsJavaScriptLibraries': 'បណ្ណាល័យ JavaScript / CSS ត្រូវបានប្រើ',
                'creditsIcons': 'Icons used',
                'creditsAnd': 'និង',
                'creditsCopyright': 'រក្សាសិទ្ធិគ្រប់យ៉ាង (c) 2016 - 2019 ដានីយ៉ែលវីប៉ែលខឺយ, យ៉ូអេលស៊ីច',
                'creditsLicense': 'អាជ្ញាប័ណ្ណអាជ្ញាប័ណ្ណ MIT',
                'creditsGithub': 'ឃ្លាំង Github',
                'creditsSuggestions': 'សូមផ្ញើសំណើនិងកំហុសទៅ support@noplaceleft.tools',
                'btnOKStart': 'យល់ព្រមសូមចាប់ផ្តើម!'
            }
        },
    },
    pl: {
